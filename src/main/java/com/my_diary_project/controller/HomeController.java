package com.my_diary_project.controller;
...
import com.my_diary_project.service.EntryService;
import com.my_diary_project.service.UserService;
...
public class HomeController {
	...
	public String saveentry(@ModelAttribute("entry") Entry entry, Model model)
	{
		...
		return authenticateuser(user1, model);
	}
	...
	public String viewentry(@RequestParam("id") int id, Model model) {
	    ...
	    // If needed, add user to the model
